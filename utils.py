...
def initLoadData():
    ...
    for index in range(len(poke_data)):
        obj_pokemon = Pokemon(poke_data[index][0], poke_data[index][2], poke_data[index][3],
                              poke_data[index][4], poke_data[index][5], poke_data[index][6], poke_data[index][7])
        ...
        obj_pokemon.setSattk(obj_pokemon.getPuntosAtaqueFisicoBase())
        obj_pokemon.setAttk(obj_pokemon.getPuntosAtaqueEspecialBase())
